...
for x in range(3):
    #img = cv2.imread('D:/Users/subas/Nextcloud/MachineLearning_Task7and8/data/my_data/test/cups/1.' + str(x+1) + str('.') + str('jpeg'),0)
    img = cv2.imread('D:/NextCloud/Rajanayagam/_Archive/MachineLearning_Task7and8/data/my_data/test/cups/1.' + str(x+1) + str('.') + str('jpeg'),0)
    print(img.shape)
    edges = cv2.Canny(img,100,200)
    img = cv2.imwrite('D:/NextCloud/Rajanayagam/_Archive/MachineLearning_Task7and8/data/my_data/edge_detected/test/cups/1.' + str(x+1) + str('.') + str('jpeg'),edges)

# Visualizing grayscaled and edged images
img = cv2.imread('D:/NextCloud/Rajanayagam/_Archive/MachineLearning_Task7and8/data/my_data/test/cups/1.1.jpeg',0)
edges = cv2.Canny(img,100,200)
